defmodule Brahman.Ewma do
  ...
  """
  @spec new(age :: float() | integer()) :: Simple.t() | Variable.t()
  ...
  def new(age) when is_float(age) do
    %Variable{decay: 2 / (age + 1)}
  end
  ...
  """
  @spec value(Simple.t() | Variable.t()) :: float()
  ...
  @spec set(Simple.t() | Variable.t(), float()) :: Simple.t() | Variable.t()
  def set(%Simple{} = ewma, value), do: %{ewma | value: value}
